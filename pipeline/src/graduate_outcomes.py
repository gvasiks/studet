...
# 6 лет) -> 48721, ординатура -> 49721. 44/46/49/50 (профессиональные
# программы поверх бакалавра, ординатура и т.п.) сознательно не
# сопоставлены ни с одним нашим уровнем.
