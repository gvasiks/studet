...
from sources import bsa, lbtu, lu, rgsl, riseba, rtu_liepaja, sse_riga, tsi, turiba, venta

SOURCES = [turiba, riseba, rtu_liepaja, tsi, bsa, sse_riga, rgsl, lu, venta, lbtu]
