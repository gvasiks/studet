...
from sources import bsa, du, eka, lbtu, lu, rgsl, riseba, rnu, rtu_liepaja, sse_riga, tsi, turiba, venta

SOURCES = [turiba, riseba, rtu_liepaja, tsi, bsa, sse_riga, rgsl, lu, venta, lbtu, du, eka, rnu]
