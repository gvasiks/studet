...
RULES: list[tuple[str, list[str]]] = [
    ...
    (r"podolo[gģ]", ["726"]),
    (r"sociālā aprūpe", ["762"]),
    (r"radiolo[gģ]", ["725"]),
    (r"sterilizācij|mākslīgā asinsrite", ["725"]),
    ...
    (r"kuģu mehānik|kuģa mehāniķ|kuģu elektro", ["525"]),
    (r"kuģa vadīšan|jūras transport|pārvadājumu organizācij", ["840"]),
    (r"autoserv", ["525"]),
    (r"aukstumtehnik|refrigerat", ["522", "521"]),
    (r"kokapstrād", ["543"]),
    (r"augkopīb|lauksaimniec|agricultur", ["621"]),
    (r"tiesisk\w* regulēj", ["380"]),
    (r"komercdarb", ["345"]),
    (r"pasākumu producēšan", ["345"]),
    (r"policij", ["861"]),
