...
| `rsu/uznemsanas-noteikumi-pamatstudijas-2026-27-rev1.pdf` | Uzņemšanas noteikumi RSU 2026./2027., iekšējais normatīvais akts 1-PB-9/36/2025 (01.12.2025) с поправками 1-PB-9/14/2026 (18.03.2026) и 1-PB-9/29/2026 (14.05.2026); 72 страницы, 1,35 МБ | [rsu.lv](https://www.rsu.lv/sites/default/files/imce/Dokumenti/noteikumi/uznemsanas_noteikumi_pamatstudijas_2026_2027_rev1.pdf) | 2026-09-20 | 18 (`pipeline/src/formulas_rsu.py`) |
| `lbtu/uznemsanas-noteikumi-pamatstudijas-2026-27-arce-12052026.pdf` | Uzņemšanas noteikumi pamatstudijās, ņemot vērā CE rezultātus 2026./2027., Senāta lēmums Nr. 12-62 (12.11.2025), редакция от 12.05.2026; 8 страниц, 418 КБ | [lbtu.lv](https://www.lbtu.lv/sites/default/files/2026-05/Uznemsanas_noteikumi_pamatstudijas_2026_2027_arCE_12052026.pdf) | 2026-09-20 | 0 — разбор заблокирован, см. WORKPLAN |
| `du/uznemsanas-noteikumi-pamatstudijas-2026-27.pdf` | Uzņemšanas noteikumi pilna un nepilna laika pamatstudijām 2026., Senāta protokols Nr. 15 (21.10.2025), grozījumi 11.06.2026; 7 страниц, 466 КБ | [du.lv](https://du.lv/wp-content/uploads/2026/06/2026_Uznem_not_pilna_nep_laika_pamatstudijam.pdf) | 2026-09-20 | 0 — заблокировано, см. WORKPLAN |
| `du/studiju-iespejas-pamatstudijas-2026-27-08-2026.pdf` | DU «Studiju iespējas» 2026: коэффициенты по программам; grozījumi до 05.08.2026 (protokols Nr. 10); 10 страниц, 595 КБ | [du.lv](https://du.lv/wp-content/uploads/2026/08/Stud_iesp_pil_nep_laika_pamatstudijam_08_2026.pdf) | 2026-09-20 | 0 — заблокировано, см. WORKPLAN |
...
1. Скачать файл в `docs/source-documents/<вуз>/`, имя — по образцу выше (год
   правил в имени).
2. В `pipeline/src/seed_formulas.py` (или в разборщике документа, как `formulas_lu.py` / `formulas_rsu.py`) заведите `source_protocol(...)` с номером,
